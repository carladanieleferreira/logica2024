...
*/
	funcao inicio()
	{
		inteiro opcao,numero=0, quantidade_convidados=0 , valorTotal=0, vago=5, reserva[50]
				...
				se(opcao==1) 
						{
							...
							}escreva("Sem mais vagas disponíveis, remova um nome antes de prosseguir caso queira aletar a lista de convidados.\n")
						}
 ...
 * @POSICAO-CURSOR = 2128; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {vago, 20, 66, 4}-{reserva, 20, 74, 7}-{nome, 21, 9, 4};
